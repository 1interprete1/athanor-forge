...
export function ModelSelectionOverlay({ 
  ...
  const handleOpen = () => {
    const groupId = startGroup("Athanor Forja: Deployment & Integrity Audit");
    addLog('Audit', 'info', "Verificando anclaje de títulos: 'Athanor Forja'", { groupId });
            ...
            <div className="px-8 py-6 border-b border-white/5 flex items-center justify-between bg-white/5 relative z-[110]">
              <div className="flex items-center gap-8">
                <div className="flex flex-col">
                  <h2 className="text-2xl font-bold text-white tracking-tight">Athanor Forja | Explorer</h2>
