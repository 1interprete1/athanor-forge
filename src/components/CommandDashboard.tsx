...
export const CommandDashboard: React.FC<CommandDashboardProps> = ({ 
  ...
  const { quota, usdToMxnRate, fxTimestamp, performanceHistory, activeSessionId, isMobile } = useStore();
  ...
  const dashboardContent = (
    ...
    >
      {/* Header */}
      <div className={`flex items-center justify-between ${isMobile ? 'px-4 py-4' : 'px-8 py-6'} border-b border-zinc-900 backdrop-blur-xl bg-neutral-950/80 relative z-[110]`}>
        <div className="flex items-center gap-3">
          <div className="p-2 bg-orange-500/10 border border-orange-500/20">
            <LayoutDashboard className={isMobile ? "w-4 h-4 text-orange-500" : "w-5 h-5 text-orange-500"} />
          </div>
          <h2 className={`${isMobile ? 'text-sm' : 'text-lg'} font-bold text-white uppercase tracking-widest`}>
            {isMobile ? 'Infrastructure' : 'Athanor Forja: Infrastructure Dashboard'}
          </h2>
        </div>
        <motion.button
      ...
      {/* Content */}
      <div className={`flex-1 overflow-y-auto ${isMobile ? 'p-4' : 'p-8'} space-y-12 scrollbar-hide`}>
            ...
            <div className="bg-zinc-950 border border-zinc-900 rounded-none p-6 space-y-6 relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="space-y-1">
                  ...
                  <h4 className={`${isMobile ? 'text-2xl' : 'text-4xl'} font-bold text-white tracking-tight`}>275.9K</h4>
                </div>
            ...
            <div className="bg-zinc-950 border border-zinc-900 rounded-none p-6 space-y-6 relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="space-y-1">
                  ...
                  <div className={`flex ${isMobile ? 'flex-col gap-1' : 'items-baseline gap-3'}`}>
                    <h4 className={`${isMobile ? 'text-2xl' : 'text-4xl'} font-bold text-white tracking-tight`}>${totalSpend.toFixed(4)} <span className="text-xs text-neutral-500 font-normal">USD</span></h4>
                    {!isMobile && <div className="h-6 w-[1px] bg-white/10" />}
                    <h4 className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-emerald-500 tracking-tight`}>${(totalSpend * usdToMxnRate).toFixed(2)} <span className="text-[10px] text-emerald-500/50 font-normal">MXN</span></h4>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          ...
          <div className={`bg-zinc-950 border border-zinc-900 rounded-none ${isMobile ? 'p-4' : 'p-8'} font-mono`}>
            <div className="space-y-4">
              <div className={`flex ${isMobile ? 'flex-col gap-1' : 'items-center justify-between'} text-[11px]`}>
                <span className="text-neutral-500 uppercase tracking-widest">Active Branch Cost</span>
                {!isMobile && <div className="flex-1 mx-4 border-b border-dotted border-zinc-800" />}
              ...
              <div className={`pt-4 border-t border-zinc-900 flex ${isMobile ? 'flex-col gap-2' : 'items-center justify-between'} text-[12px]`}>
      ...
      {/* Footer */}
      <div className={`${isMobile ? 'px-4 py-4' : 'px-8 py-4'} border-t border-zinc-900 flex flex-col sm:flex-row justify-between items-center bg-black/40 gap-4`}>
        <div className="flex flex-col">
          <span className="text-[9px] font-bold text-neutral-600 uppercase tracking-widest">
            Athanor Forja Infrastructure v1.0.0 | Build AF-217
          </span>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="text-[9px] font-bold text-emerald-500 uppercase tracking-widest">
              {isMobile ? '[CERTIFIED]' : '[SYSTEM_STATUS: CERTIFIED // BUILD_AF-217 // LPU_ENCRYPTED_LINK: ACTIVE]'}
            </span>
          </motion.button>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="text-center space-y-2 relative z-10">
                ...
                <h3 className="text-lg font-bold text-white uppercase tracking-widest">Athanor Forja Placa de Características</h3>
