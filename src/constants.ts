...
# ATHANOR FORJA: PIPELINE GOLD MASTER (AF-221)
# ==========================================================
& {
    ...
    Write-Host ">>> Subiendo a GitHub (Bypass Credential Manager)..." -ForegroundColor Cyan
    # Force git to use the token in the URL by disabling the credential helper for this command
    $pushResult = & $GitExe -c "credential.helper=" push -u origin main --force 2>&1
