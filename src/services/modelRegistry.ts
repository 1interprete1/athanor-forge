...
export const MODEL_METADATA_REGISTRY: Record<string, ModelMetadata> = {
  'openai/gpt-oss-120b': {
    ...
    parameters: '120B',
    lore: "El motor raíz de Athanor Forja. Un titán de 120B parámetros diseñado para el razonamiento profundo y la versatilidad técnica. La cúspide de la inferencia abierta.",
    tps: 150,
    latency: 200,
    capabilities: {
      jsonMode: true,
  ...
  'llama-3.3-70b-specdec': {
    ...
    parameters: '70B',
    lore: "Speculative Decoding variant. Optimized for extreme throughput by guessing future tokens. A high-speed engine for real-time applications within Athanor Forja.",
    tps: 450,
    latency: 80,
    capabilities: {
      jsonMode: true,
  ...
  'llama-3.2-11b-vision-preview': {
    ...
    parameters: '11B',
    lore: "Meta's multimodal frontier. Efficiently orchestrates image reasoning and high-density text inference. The first step into visual intelligence for Athanor Forja.",
    tps: 400,
    latency: 90,
    capabilities: {
      jsonMode: true,
  ...
  'llama-3.2-90b-vision-preview': {
    ...
    cons: ['Alta latencia'],
    parameters: '90B',
    lore: "The multimodal titan. Meta's 90B vision model brings high-fidelity image understanding to the Athanor Forja infrastructure, optimized for complex visual reasoning.",
    tps: 120,
    latency: 280,
    capabilities: {
      jsonMode: true,
  ...
  'llama-3.1-8b-instant': {
    ...
    parameters: '8B',
    lore: "Meta's lightweight powerhouse. Optimized for high-throughput and low-latency inference. The gold standard for sub-10B parameter efficiency, delivering rapid-fire responses for Athanor Forja users.",
    tps: 850,
    latency: 45,
    capabilities: {
      jsonMode: true,
  ...
  'llama3-70b-8192': {
    ...
    parameters: '70B',
    lore: "The original Llama 3 titan. While context-limited compared to 3.1, it remains a benchmark for dense 70B reasoning capabilities, serving as a reliable engine within Athanor Forja.",
    tps: 220,
    latency: 150,
    benchmarks: [
  ...
  'llama3-8b-8192': {
    ...
    parameters: '8B',
    lore: "The model that brought high-quality inference to the edge. Fast, reliable, and highly steerable for basic classification and chat, optimized for Athanor Forja's rapid-response needs.",
    tps: 780,
    latency: 55,
    benchmarks: [
  ...
  'mixtral-8x7b-32768': {
    ...
    lore: "The MoE (Mixture of Experts) efficiency king. Orchestrates 8 expert networks for near-GPT4 performance with sparse compute. A milestone in open-source MoE, integrated seamlessly into Athanor Forja.",
    tps: 320,
    latency: 180,
    capabilities: {
      jsonMode: true,
  ...
  'gemma2-9b-it': {
    ...
    parameters: '9B',
    lore: "Google’s lightweight powerhouse, derived from the same technology behind Gemini. Exceptional at reasoning tasks for its parameter class, providing a balanced compute profile for Athanor Forja.",
    tps: 450,
    latency: 95,
    benchmarks: [
  ...
  'deepseek-r1-distill-llama-70b': {
    ...
    parameters: '70B',
    lore: "State-of-the-art Reasoning optimization. Distilled logic from R1 into the versatile Llama architecture. Enabling deep-dive analysis within Athanor Forja.",
    tps: 180,
    latency: 350,
    capabilities: {
      jsonMode: true,
  ...
  'whisper-large-v3': {
    ...
    parameters: '1.55B',
    lore: "The state-of-the-art in speech recognition. While primarily an audio model, its integration into Athanor Forja serves as a stress-test for context window management and rapid-fire token saturation.",
    tps: 50,
    latency: 100,
    capabilities: {
      jsonMode: false,
